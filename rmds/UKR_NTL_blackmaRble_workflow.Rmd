...
- It is possible that you will get a message saying the imagery from the NRT collection is not available. If this happens it is because you are somehow logged into LAADs system, but not the NRT catalogue. In this case go to the [NRT Portal](https://nrt3.modaps.eosdis.nasa.gov/archive/allData/5000/VNP46A1G_NRT/2022/073) and click log in.
